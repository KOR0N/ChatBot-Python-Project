    ...
    if question == 1 :
        ...
        match question:
            ...
            case 3:
                ...
                if choice == "o" :
                    presidents_name_display(name_association(recup_nom(files_names)))
                ...
                mot_max = mots_plus_répétés_par_président(president_name,tf_list,files_names,non_important)
                print("Le(s) mot(s) le(s) plus répété(s) par",president_name, "est (sont) :",mot_max)
            case 4:
